...
Now briefly summarize our progress of this project.	
 ...
 &nbsp; &nbsp;1.) Data cleaning. Dropped missing data and wrangled the data.
 
 &nbsp; &nbsp;2.)	Exploratory data analysis. Compared isotopes in different taxon and sites.
 
 &nbsp; &nbsp;3.) Tests. Two-Sample T-tests and Mann Whitney U Test show that all the isotope levels are the same between BAOX and PATT.
