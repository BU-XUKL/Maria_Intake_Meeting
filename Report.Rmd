...
&nbsp; &nbsp; Since isotopes can enter animals' bones by eating, through the comparisons of average levels of carbon and nitrogen isotopes from ancient animals' bones in two sites of ancient Mexico, we can conclude about whether animals from two sites of ancient Mexico had similar diets.
...
&nbsp; &nbsp; Now briefly summarize our progress of this project.	
 ...
 &nbsp; &nbsp;3.) Tests. Did Two-Sample T-tests and Mann Whitney U test to compare the average isotopes' levels between BAOX and PATT, two sites in ancient Mexico, for each kind of animal.

&nbsp; &nbsp; The conclusion we get is, at a 0.01 significance level, all three isotope levels have a non-significant difference between BAOX and PATT.
...
&	\approx 0.46,\\
\end{aligned}$$
&nbsp; &nbsp; which means the probability of rejecting the null hypothesis by chance is 0.46, almost a half. Then, we decided to set the significant level with 0.01, $$\begin{aligned}
...
We checked all her forward works ,including the summary data table and box plots. The results of our inspection are consistent with hers, indicating that there is no problem with her data processing and EDA. At the same time, we added some EDA plots to give a better understanding of the data set.

Next, we did some tests to meet the customer's needs. We used two methods - two samples t test and Mann-Whitney U Test, to show there is no significant difference in specific animals’ diets from BAOX and PATT.
